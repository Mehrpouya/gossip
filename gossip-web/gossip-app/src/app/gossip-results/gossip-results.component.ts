...
export class GossipResultsComponent implements OnInit {
  ...
  sampleData(): void {
    let gossipSample = [new Gossip(121212, 'NHS is selling publicly owned lands', 'I\'ve heard from a very solid source that NHS is selling our lands to private companies for a very low price.', 'I\'ve heard from a very solid source that NHS is selling our lands to ...', ['banking'],[{comment:"",date_created:""}]),
  ...
  startGossip():void{
    this.visible = true;
    this.selectedGossip = new Gossip(11212,'new gossip','gossip details','',[],[{comment:"",date_created:""}]);
