...
License Summary
    ...
    Only available to charities and political causes. Political means, projects that are developed by not for profit and charities who work for the benefit of communities and society.
    Can modify source-code but cannot distribute modifications (derivative works)
    Attribution to software creator must be made as specified:

    a link back to my website hadi.link from a site/service running the software


Gossip - Terms and conditions

    Preamble: This Agreement, signed on Oct 11, 2017 (hereinafter: Effective Date) governs the relationship between Hadi Mehrpouya, a Business Entity, (hereinafter: Licensee) and Hadi Mehrpouya, a private person whose principal place of business is {location} (hereinafter: Licensor). This Agreement sets the terms, rights, restrictions and obligations on using Gossip (hereinafter: The Software) created and owned by Licensor, as detailed herein

    License Grant: Licensor hereby grants Licensee a Sublicensable, Non-assignable & non-transferable, Pepetual, Commercial with terms, Including the rights to create but not distribute derivative works, Non-exclusive license, all with accordance with the terms set forth and other legal restrictions set forth in 3rd party software used while running Software.
        ...
        Commercial use allowed with restrictions: Only available to charities and political causes. Political means, projects that are developed by not for profit and charities who work for the benefit of communities and society.
        ...
        With Attribution Requirements﻿: a link back to my website hadi.link from a site/service running the software 
